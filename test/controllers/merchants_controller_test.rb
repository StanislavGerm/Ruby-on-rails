...
class MerchantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post merchants_url, params: { merchant: { city: @merchant.city, country_code: @merchant.country_code, extra: @merchant.extra, name: @merchant.name, street: @merchant.street } }
    end
  ...
  test "should update merchant" do
    patch merchant_url(@merchant), params: { merchant: { city: @merchant.city, country_code: @merchant.country_code, extra: @merchant.extra, name: @merchant.name, street: @merchant.street } }
